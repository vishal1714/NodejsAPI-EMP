...
const SendEmail = async (Email , ActivationKey , id) => {
  // send mail with defined transport object
    await transporter.sendMail({
      from: '"Raje Tech API 👻" <bot@byraje.com>', // sender address
      to: Email, // list of receivers
      subject: "Raje API Activation Link", // Subject line
                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                <a href="https://api.raje.tech/api/activation?Key=${ActivationKey}&User=${id}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Do Something Sweet</a>
                              </td>
                            </tr>
                          </table>
                        </td>
